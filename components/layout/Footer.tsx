...
export function Footer() {
  return (
    <footer className="border-t-2 border-gray-200 bg-white py-12 transition-colors dark:border-gray-700 dark:bg-gray-800">
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          <div>
            <h3 className="mb-4 text-2xl font-bold text-primary-600 dark:text-primary-400">JubiJobs</h3>
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              Conectamos experiencia con oportunidades. Trabajos para jubilados
              y personas con discapacidad en Argentina.
            </p>
          </div>
        ...
        <div className="mt-12 border-t-2 border-gray-200 pt-8 text-center dark:border-gray-700">
          <p className="text-lg text-gray-600 dark:text-gray-400">
            © {new Date().getFullYear()} JubiJobs. Todos los derechos reservados.
          </p>
