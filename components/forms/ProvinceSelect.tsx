  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <select
        ...
        required={required}
        className="min-h-[48px] rounded-lg border border-rule bg-surface px-4 py-3 text-lg focus:border-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-300"
      >
