  ...
  return (
    <Card className="w-full max-w-md mx-auto mt-4">
      <CardHeader>
        ...
        <CardDescription>Información sobre el estado actual del tema</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div>
          ...
          <p>
            <strong>Clase en HTML:</strong> {document.documentElement.classList.contains("dark") ? "dark" : "light"}
          </p>
        </div>
