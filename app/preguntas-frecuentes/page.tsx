          ...
          <div className="space-y-6">
            <div className="rounded-xl border-2 border-gray-200 bg-white p-8 shadow-sm transition-colors dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="mb-4 text-lg text-gray-700 dark:text-gray-300">
                <strong>Sí, en la mayoría de los casos.</strong> Tanto jubilados
                nacionales como provinciales pueden trabajar sin perder su
                jubilación, aunque existen diferencias según la caja previsional
                y el tipo de empleo.
              </p>
              ...
              <p className="mb-3 text-lg text-gray-700 dark:text-gray-300">
                <strong>¿Pueden trabajar?</strong> Sí. Los jubilados del Sistema
                Integrado Previsional Argentino (SIPA) pueden trabajar sin perder
                su jubilación.
              </p>
              ...
              <p className="mb-3 text-lg text-gray-700 dark:text-gray-300">
                <strong>¿Pueden trabajar?</strong> Depende de la caja previsional
                provincial. En <strong>Córdoba (APROSS)</strong>, por ejemplo:
              </p>
              <p className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-200">
                Condiciones:
              </p>
              <ul className="mb-4 ml-6 list-disc space-y-2 text-lg text-gray-700 dark:text-gray-300">
                <li>
                  Pueden trabajar en relación de dependencia en el sector privado
                  sin perder su jubilación.
                </li>
                <li>
                  <strong>NO pueden</strong> trabajar en relación de dependencia
                  en el sector público provincial (hay suspensión del haber).
                </li>
                <li>
              ...
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                <strong>Recomendación:</strong> Cada provincia tiene sus propias
                reglas. Es importante consultar con la caja previsional
                correspondiente (APROSS en Córdoba, IPS en Santa Fe, etc.).
              </p>
              ...
              <p className="mb-3 text-lg text-gray-700 dark:text-gray-300">
                <strong>Jubilado Nacional trabajando en cualquier provincia:</strong>{" "}
                Sin problema. Puede trabajar en todo el país.
              </p>
              <p className="mb-4 text-lg text-gray-700 dark:text-gray-300">
                <strong>Jubilado Provincial trabajando en otra provincia:</strong>{" "}
                Generalmente puede trabajar sin restricciones, pero debe verificar
                las normas específicas de su caja provincial.
              </p>
              ...
              <ul className="mb-4 ml-6 list-disc space-y-2 text-lg text-gray-700 dark:text-gray-300">
                ...
                <li>
                  La empresa debe hacer aportes previsionales, pero esos aportes
                  no generan un segundo beneficio.
                </li>
              </ul>
              <p className="mb-2 text-lg font-semibold text-gray-800 dark:text-gray-200">
              ...
              <div className="mt-6 rounded-lg bg-green-50 p-4 dark:bg-green-950">
                ...
                <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                  La gran mayoría de los jubilados argentinos pueden trabajar sin
                  perder su jubilación. Si tenés dudas sobre tu caso específico,
                  consultá con ANSES (130) o con tu caja provincial.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border-2 border-gray-200 bg-white p-8 shadow-sm transition-colors dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Ingresá con tu cuenta de Google, Facebook, Microsoft o tu número de teléfono. Luego,
                buscá empleos que te interesen y hacé click en &quot;Postularme&quot;.
                Respondé 3 preguntas simples y listo. Tu postulación será
                enviada.
              </p>
            </div>
        ...
        <section className="mt-16">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border-2 border-gray-200 bg-white p-8 shadow-sm transition-colors dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                No. Pueden ser personas próximas a jubilarse o mayores de 50 que
            ...
            <div className="rounded-xl border-2 border-gray-200 bg-white p-8 shadow-sm transition-colors dark:border-gray-700 dark:bg-gray-800">
              ...
              <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
                Ves su perfil completo, incluyendo necesidades de accesibilidad,
